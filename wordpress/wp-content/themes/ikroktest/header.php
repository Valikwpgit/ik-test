...
<div class="container">
    ...
    <div class="header-right flex align-items-center">
        <div class="chat">
            <img class="chat-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/chat_bot.png" alt="" />
        </div>
        ...
        <nav class="nav">
            <img class="nav-img" src="<?php echo get_template_directory_uri(); ?>/assets/icons/hamburger.svg" alt="" />
        </nav>
    </div>
    </div>
